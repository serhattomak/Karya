        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListTitles = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ListItems = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    Urls = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    VideoTitles = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    VideoUrls = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    VideoDescriptions = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Slug = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    HomePageSubtitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Titles = table.Column<string>(type: "NVARCHAR(MAX)", nullable: false),
                    Subtitles = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    Descriptions = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ListTitles = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ...
                    BannerImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MainImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ShowContact = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ProductImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ProductMainImageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DocumentImageIds = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    ProductDetailImageIds = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    FileIds = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    DocumentIds = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
